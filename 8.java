// Custom exception for handling low balance situations
...
// Account class with deposit, withdrawal, and balance checking
class Account {
    double balance;
...
// Main class to test Account functionality
public class TestAccount {
    public static void main(String[] args) {
        ...
        try {
            account1.withdraw(1600);  // Should trigger LessBalanceException
